...
/// and advice map.
///
/// All actions, except for `MerkleNodeMerge`, `Ext2Inv`, `MerklePathToStack` and `UpdateMerkleNode`
/// can be invoked directly from Miden assembly via dedicated instructions.
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
