...
pub enum Decorator {
    /// Injects zero or more values at the head of the advice stack as specified by the injector.
    /// This operation affects only the advice stack, but has no effect on other VM components
