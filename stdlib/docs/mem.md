...
| pipe_words_to_memory | Copies an arbitrary number of words from the advice stack to memory<br /><br />Input: [num_words, write_ptr, ...]<br />Output: [HASH, write_ptr', ...]<br />Cycles:<br />even num_words: 50 + 9 * num_words / 2<br />odd num_words: 67 + 9 * round_down(num_words / 2)<br /> |
