...
"),
// ----- std::crypto::smt -------------------------------------------------------------------------
("std::crypto::smt", "# Push the leaf value at K to the stack
#
# vars:
# R: trie root
# K: trie key
...
# Update the leaf value at K and push the new root R' to the stack 
#
# vars:
# R: trie root
# K: trie key
