...
impl fmt::Display for Token<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Token::PushHornerBase => write!(f, "push_horner_base"),
            Token::PushHornerExt => write!(f, "push_horner_ext"),
...
impl<'input> Token<'input> {
    ...
    const KEYWORDS: &'static [(&'static str, Token<'static>)] = &[
        ...
        ("push_horner_base", Token::PushHornerBase),
        ("push_horner_ext", Token::PushHornerExt),
        ("and", Token::And),
        ("assert", Token::Assert),
