use super::{parse_u32_param, validate_operation, ArgsMap, AssemblyError, Operation, Token, Vec};
...
pub fn parse_push_adv(
    ...
    let n = parse_u32_param(op, 2, 1, ADVICE_READ_LIMIT, proc_args, is_proc_declaration)?;
...
mod tests {
    use super::{
        ...
        ArgsMap, AssemblyError, Operation, Token, ADVICE_READ_LIMIT,
    };
    ...
    fn push_adv() {
        ...
        parse_push(&mut span_ops, &op, num_proc_locals, &ArgsMap::new(), false)
            .expect("Failed to parse push.adv.4");
    ...
    fn loadw_adv() {
        ...
        parse_loadw(&mut span_ops, &op, num_proc_locals, &ArgsMap::new(), false)
            .expect("Failed to parse loadw.adv");
        assert_eq!(span_ops, expected);
    }
