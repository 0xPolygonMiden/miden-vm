use super::{AssemblyError, Felt, Operation, Vec};
...
pub(super) fn parse_rphash(span_ops: &mut Vec<Operation>) -> Result<(), AssemblyError> {
...
pub(super) fn parse_rpperm(span_ops: &mut Vec<Operation>) -> Result<(), AssemblyError> {
