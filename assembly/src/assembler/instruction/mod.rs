...
impl Assembler {
    pub(super) fn compile_instruction(
        ...
        let result = match instruction {
            ...
            Instruction::U32Div => u32_ops::u32div(span, Unchecked, None),
            Instruction::U32DivImm(v) => u32_ops::u32div(span, Unchecked, Some(*v)),
            ...
            Instruction::U32Mod => u32_ops::u32mod(span, Unchecked, None),
            Instruction::U32ModImm(v) => u32_ops::u32mod(span, Unchecked, Some(*v)),
            ...
            Instruction::U32DivMod => u32_ops::u32divmod(span, Unchecked, None),
            Instruction::U32DivModImm(v) => u32_ops::u32divmod(span, Unchecked, Some(*v)),
            ...
            Instruction::U32Shl => u32_ops::u32shl(span, Unchecked, None),
            Instruction::U32ShlImm(v) => u32_ops::u32shl(span, Unchecked, Some(*v)),
            ...
            Instruction::U32Shr => u32_ops::u32shr(span, Unchecked, None),
            Instruction::U32ShrImm(v) => u32_ops::u32shr(span, Unchecked, Some(*v)),
            ...
            Instruction::U32Rotl => u32_ops::u32rotl(span, Unchecked, None),
            Instruction::U32RotlImm(v) => u32_ops::u32rotl(span, Unchecked, Some(*v)),
            ...
            Instruction::U32Rotr => u32_ops::u32rotr(span, Unchecked, None),
            Instruction::U32RotrImm(v) => u32_ops::u32rotr(span, Unchecked, Some(*v)),
            Instruction::U32CheckedPopcnt => u32_ops::u32popcnt(span, Checked),
            Instruction::U32Popcnt => u32_ops::u32popcnt(span, Unchecked),
            ...
            Instruction::U32Lt => u32_ops::u32lt(span, Unchecked),
            Instruction::U32CheckedLte => u32_ops::u32lte(span, Checked),
            Instruction::U32Lte => u32_ops::u32lte(span, Unchecked),
            Instruction::U32CheckedGt => u32_ops::u32gt(span, Checked),
            Instruction::U32Gt => u32_ops::u32gt(span, Unchecked),
            Instruction::U32CheckedGte => u32_ops::u32gte(span, Checked),
            Instruction::U32Gte => u32_ops::u32gte(span, Unchecked),
            Instruction::U32CheckedMin => u32_ops::u32min(span, Checked),
            Instruction::U32Min => u32_ops::u32min(span, Unchecked),
            Instruction::U32CheckedMax => u32_ops::u32max(span, Checked),
            Instruction::U32Max => u32_ops::u32max(span, Unchecked),
