...
impl Assembler {
    ...
    fn compile_instruction_impl(
        ...
        match instruction {
            ...
            Instruction::Sub => span_builder.push_ops([Neg, Add]),
            Instruction::SubImm(imm) => field_ops::sub_imm(span_builder, imm.expect_value()),
            Instruction::Mul => span_builder.push_op(Mul),
            ...
            Instruction::Not => span_builder.push_op(Not),
            Instruction::And => span_builder.push_op(And),
            Instruction::Or => span_builder.push_op(Or),
            Instruction::Xor => span_builder.push_ops([Dup0, Dup2, Or, MovDn2, And, Not, And]),

            Instruction::Eq => span_builder.push_op(Eq),
            ...
            Instruction::DropW => span_builder.push_ops([Drop; 4]),
            Instruction::PadW => span_builder.push_ops([Pad; 4]),
            Instruction::Dup0 => span_builder.push_op(Dup0),
            Instruction::Dup1 => span_builder.push_op(Dup1),
            Instruction::Dup2 => span_builder.push_op(Dup2),
            Instruction::Dup3 => span_builder.push_op(Dup3),
            Instruction::Dup4 => span_builder.push_op(Dup4),
            Instruction::Dup5 => span_builder.push_op(Dup5),
            Instruction::Dup6 => span_builder.push_op(Dup6),
            Instruction::Dup7 => span_builder.push_op(Dup7),
            Instruction::Dup8 => span_builder.push_ops([Pad, Dup9, Add]),
            Instruction::Dup9 => span_builder.push_op(Dup9),
            Instruction::Dup10 => span_builder.push_ops([Pad, Dup11, Add]),
            Instruction::Dup11 => span_builder.push_op(Dup11),
            Instruction::Dup12 => span_builder.push_ops([Pad, Dup13, Add]),
            Instruction::Dup13 => span_builder.push_op(Dup13),
            Instruction::Dup14 => span_builder.push_ops([Pad, Dup15, Add]),
            Instruction::Dup15 => span_builder.push_op(Dup15),
            Instruction::DupW0 => span_builder.push_ops([Dup3; 4]),
            Instruction::DupW1 => span_builder.push_ops([Dup7; 4]),
            Instruction::DupW2 => span_builder.push_ops([Dup11; 4]),
            Instruction::DupW3 => span_builder.push_ops([Dup15; 4]),
            Instruction::Swap1 => span_builder.push_op(Swap),
            Instruction::Swap2 => span_builder.push_ops([Swap, MovUp2]),
            Instruction::Swap3 => span_builder.push_ops([MovDn2, MovUp3]),
            Instruction::Swap4 => span_builder.push_ops([MovDn3, MovUp4]),
            Instruction::Swap5 => span_builder.push_ops([MovDn4, MovUp5]),
            Instruction::Swap6 => span_builder.push_ops([MovDn5, MovUp6]),
            Instruction::Swap7 => span_builder.push_ops([MovDn6, MovUp7]),
            Instruction::Swap8 => span_builder.push_ops([MovDn7, MovUp8]),
            ...
            Instruction::SwapDw => span_builder.push_op(SwapDW),
            Instruction::MovUp2 => span_builder.push_op(MovUp2),
            Instruction::MovUp3 => span_builder.push_op(MovUp3),
            Instruction::MovUp4 => span_builder.push_op(MovUp4),
            Instruction::MovUp5 => span_builder.push_op(MovUp5),
            Instruction::MovUp6 => span_builder.push_op(MovUp6),
            Instruction::MovUp7 => span_builder.push_op(MovUp7),
            Instruction::MovUp8 => span_builder.push_op(MovUp8),
            Instruction::MovUp9 => span_builder.push_ops([SwapDW, Swap, SwapDW, MovUp8]),
            Instruction::MovUp10 => span_builder.push_ops([SwapDW, MovUp2, SwapDW, MovUp8]),
            Instruction::MovUp11 => span_builder.push_ops([SwapDW, MovUp3, SwapDW, MovUp8]),
            Instruction::MovUp12 => span_builder.push_ops([SwapDW, MovUp4, SwapDW, MovUp8]),
            Instruction::MovUp13 => span_builder.push_ops([SwapDW, MovUp5, SwapDW, MovUp8]),
            Instruction::MovUp14 => span_builder.push_ops([SwapDW, MovUp6, SwapDW, MovUp8]),
            Instruction::MovUp15 => span_builder.push_ops([SwapDW, MovUp7, SwapDW, MovUp8]),
            Instruction::MovUpW2 => span_builder.push_ops([SwapW, SwapW2]),
            Instruction::MovUpW3 => span_builder.push_ops([SwapW, SwapW2, SwapW3]),
            Instruction::MovDn2 => span_builder.push_op(MovDn2),
            Instruction::MovDn3 => span_builder.push_op(MovDn3),
            Instruction::MovDn4 => span_builder.push_op(MovDn4),
            Instruction::MovDn5 => span_builder.push_op(MovDn5),
            Instruction::MovDn6 => span_builder.push_op(MovDn6),
            Instruction::MovDn7 => span_builder.push_op(MovDn7),
            Instruction::MovDn8 => span_builder.push_op(MovDn8),
            Instruction::MovDn9 => span_builder.push_ops([MovDn8, SwapDW, Swap, SwapDW]),
            Instruction::MovDn10 => span_builder.push_ops([MovDn8, SwapDW, MovDn2, SwapDW]),
            Instruction::MovDn11 => span_builder.push_ops([MovDn8, SwapDW, MovDn3, SwapDW]),
            Instruction::MovDn12 => span_builder.push_ops([MovDn8, SwapDW, MovDn4, SwapDW]),
            Instruction::MovDn13 => span_builder.push_ops([MovDn8, SwapDW, MovDn5, SwapDW]),
            Instruction::MovDn14 => span_builder.push_ops([MovDn8, SwapDW, MovDn6, SwapDW]),
            Instruction::MovDn15 => span_builder.push_ops([MovDn8, SwapDW, MovDn7, SwapDW]),
            Instruction::MovDnW2 => span_builder.push_ops([SwapW2, SwapW]),
            Instruction::MovDnW3 => span_builder.push_ops([SwapW3, SwapW2, SwapW]),

            Instruction::CSwap => span_builder.push_op(CSwap),
            Instruction::CSwapW => span_builder.push_op(CSwapW),
            Instruction::CDrop => span_builder.push_ops([CSwap, Drop]),
            Instruction::CDropW => span_builder.push_ops([CSwapW, Drop, Drop, Drop, Drop]),
            ...
            Instruction::HPerm => span_builder.push_op(HPerm),
