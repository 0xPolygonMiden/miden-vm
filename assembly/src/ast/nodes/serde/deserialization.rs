...
impl Deserializable for Instruction {
    fn read_from<R: ByteReader>(source: &mut R) -> Result<Self, DeserializationError> {
        ...
        match opcode {
            ...
            OpCode::U32UncheckedDiv => Ok(Instruction::U32Div),
            OpCode::U32UncheckedDivImm => Ok(Instruction::U32DivImm(source.read_u32()?)),
            OpCode::U32CheckedMod => Ok(Instruction::U32CheckedMod),
            OpCode::U32CheckedModImm => Ok(Instruction::U32CheckedModImm(source.read_u32()?)),
            OpCode::U32UncheckedMod => Ok(Instruction::U32Mod),
            OpCode::U32UncheckedModImm => Ok(Instruction::U32ModImm(source.read_u32()?)),
            ...
            OpCode::U32UncheckedDivMod => Ok(Instruction::U32DivMod),
            OpCode::U32UncheckedDivModImm => Ok(Instruction::U32DivModImm(source.read_u32()?)),
            OpCode::U32CheckedAnd => Ok(Instruction::U32And),
            OpCode::U32CheckedOr => Ok(Instruction::U32Or),
            OpCode::U32CheckedXor => Ok(Instruction::U32Xor),
            OpCode::U32CheckedNot => Ok(Instruction::U32Not),
            OpCode::U32CheckedShr => Ok(Instruction::U32CheckedShr),
            OpCode::U32CheckedShrImm => Ok(Instruction::U32CheckedShrImm(source.read_u8()?)),
            OpCode::U32UncheckedShr => Ok(Instruction::U32Shr),
            OpCode::U32UncheckedShrImm => Ok(Instruction::U32ShrImm(source.read_u8()?)),
            OpCode::U32CheckedShl => Ok(Instruction::U32CheckedShl),
            OpCode::U32CheckedShlImm => Ok(Instruction::U32CheckedShlImm(source.read_u8()?)),
            OpCode::U32UncheckedShl => Ok(Instruction::U32Shl),
            OpCode::U32UncheckedShlImm => Ok(Instruction::U32ShlImm(source.read_u8()?)),
            ...
            OpCode::U32UncheckedRotr => Ok(Instruction::U32Rotr),
            OpCode::U32UncheckedRotrImm => Ok(Instruction::U32RotrImm(source.read_u8()?)),
            ...
            OpCode::U32UncheckedRotl => Ok(Instruction::U32Rotl),
            OpCode::U32UncheckedRotlImm => Ok(Instruction::U32RotlImm(source.read_u8()?)),
            OpCode::U32CheckedPopcnt => Ok(Instruction::U32CheckedPopcnt),
            OpCode::U32UncheckedPopcnt => Ok(Instruction::U32Popcnt),
            ...
            OpCode::U32UncheckedLt => Ok(Instruction::U32Lt),
            OpCode::U32CheckedLte => Ok(Instruction::U32CheckedLte),
            OpCode::U32UncheckedLte => Ok(Instruction::U32Lte),
            OpCode::U32CheckedGt => Ok(Instruction::U32CheckedGt),
            OpCode::U32UncheckedGt => Ok(Instruction::U32Gt),
            OpCode::U32CheckedGte => Ok(Instruction::U32CheckedGte),
            OpCode::U32UncheckedGte => Ok(Instruction::U32Gte),
            OpCode::U32CheckedMin => Ok(Instruction::U32CheckedMin),
            OpCode::U32UncheckedMin => Ok(Instruction::U32Min),
            OpCode::U32CheckedMax => Ok(Instruction::U32CheckedMax),
            OpCode::U32UncheckedMax => Ok(Instruction::U32Max),
