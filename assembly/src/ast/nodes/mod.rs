...
pub enum Instruction {
    ...
    U32CheckedPopcnt,
    U32UncheckedPopcnt,
    U32CheckedTrailingZeros,
    U32UncheckedTrailingZeros,
    U32CheckedEq,
    U32CheckedEqImm(u32),
    U32CheckedNeq,
...
impl fmt::Display for Instruction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::U32CheckedTrailingZeros => write!(f, "u32checked_trailing_zeros"),
            Self::U32UncheckedTrailingZeros => write!(f, "u32unchecked_trailing_zeros"),
