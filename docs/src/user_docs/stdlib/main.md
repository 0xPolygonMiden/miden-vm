...
* Provide highly-optimized and battle-tested implementations of commonly-useful primitives.
...
## Available modules
Currently, Miden standard library contains just a few modules listed below. Over time, we plan to add many more modules which will include various cryptographic primitives, additional numeric data types and operations, and many others.
