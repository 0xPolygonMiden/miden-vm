...
- [Design](./design/main.md)
  ...
  - [Operand stack](./design/stack/main.md)
    - [Unique Identifier](./design/stack/unique_identifier.md)
    - [System operations](./design/stack/system_operations.md)
    - [Field operations](./design/stack/field_operation.md)
    - [u32 operations](./design/stack/u32_operations.md)
    - [Stack manipulation operations](./design/stack/stack_manipulation_operations.md)
    - [I/O operations](./design/stack/io_operations.md)
    - [Cryptographic operations](./design/stack/cryptographic_operations.md)
    - [Decorator operations](./design/stack/decorator_operations.md)
