use super::{
    ...
    TraceState, UserOps, CYCLE_MASK_IDX, PREFIX_MASK_IDX, PUSH_MASK_IDX,
};
...
pub fn enforce_op_bits(
    ...
    let mut cf_bit_sum = BaseElement::ZERO;
    ...
    let mut ld_bit_prod = BaseElement::ONE;
    ...
    let mut hd_bit_prod = BaseElement::ONE;
    ...
    let hacc_transition = (op_counter + BaseElement::ONE) * is_hacc;
