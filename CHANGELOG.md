...
- [BREAKING] Renamed `Assembler::add_module` to `Assembler::compile_and_link_module` (#1881)
- [BREAKING] Renamed `Assembler::add_modules` to `Assembler::compile_and_link_modules` (#1881)
- [BREAKING] Renamed `Assembler::add_modules_from_dir` to `Assembler::compile_and_link_modules_from_dir` (#1881)
- [BREAKING] Removed `Assembler::add_module_with_options` (#1881)
- [BREAKING] Removed `Assembler::add_modules_with_options` (#1881)
- [BREAKING] Renamed `Assembler::add_library` to `Assembler::link_library` (#1881)
- [BREAKING] Renamed `Assembler::add_vendored_library` to `Assembler::link_vendored_library` (#1881)
