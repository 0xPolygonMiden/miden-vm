...
impl MainTraceFragmentGenerator {
    ...
    pub fn add_dyn_trace_row(&mut self, dyn_node: &DynNode, trace_type: TraceRowType) {
    ...
    pub fn add_dyn_start_trace_row(&mut self, dyn_node: &DynNode) {
    ...
    pub fn add_dyn_end_trace_row(&mut self, dyn_node: &DynNode) {
