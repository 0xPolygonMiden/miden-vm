...
impl ExecutionTrace {
    ...
    pub(super) fn new<ADV>(process: Process<ADV>, program_outputs: ProgramOutputs) -> Self
    where
        ADV: AdviceProvider,
    {
    ...
    #[cfg(test)]
    pub fn test_finalize_trace<ADV>(process: Process<ADV>) -> (Vec<Vec<Felt>>, AuxTraceHints)
    where
        ADV: AdviceProvider,
    {
