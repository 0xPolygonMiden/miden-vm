use super::{
    super::utils::get_trace_len, get_num_groups_in_next_batch, Felt, Operation, Vec, Word,
    DIGEST_LEN, MIN_TRACE_LEN, NUM_HASHER_COLUMNS, NUM_OP_BATCH_FLAGS, NUM_OP_BITS,
