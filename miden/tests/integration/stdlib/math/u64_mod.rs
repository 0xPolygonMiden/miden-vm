...
fn checked_add() {
    ...
    let a0 = u64::from(rand_value::<u64>() as u16);
    let b0 = u64::from(rand_value::<u64>() as u16);
    let a1 = u64::from(rand_value::<u64>() as u16);
    let b1 = u64::from(rand_value::<u64>() as u16);
    let c0 = a0 + b0;
    let c1 = a1 + b1;
...
fn checked_add_fail() {
    ...
    // result overflow
    let a0 = u64::from(rand_value::<u64>() as u32);
    let b0 = u64::from(rand_value::<u64>() as u32);
    let a1 = u64::from(u32::MAX);
    let b1 = u64::from(u32::MAX);
...
fn checked_sub() {
    ...
    let dif = u64::from(rand_value::<u64>() as u16);
...
fn checked_mul_fail() {
    ...
    // result overflow
    let a0 = u64::from(rand_value::<u64>() as u32);
    let a1 = u64::from(u16::MAX) + u64::from(rand_value::<u64>() as u16);
    let b0 = u64::from(u16::MAX) + u64::from(rand_value::<u64>() as u16);
    let b1 = 0u64;
...
fn overflowing_shl() {
    ...
    let shl_to_u128 = |a: u64, b: u32| -> u128 { u128::from(a) << b };
    ...
    build_test!(source, &[5, a0, a1, u64::from(b)]).expect_stack(&[d1, d0, c1, c0, 5]);
