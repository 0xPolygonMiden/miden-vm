...
fn test_ecgfp5_point_validate(a0: u64, a1: u64, a2: u64, a3: u64, a4: u64, should_validate: bool) {
    let source = "
...
fn test_ecgfp5_point_decode(a0: u64, a1: u64, a2: u64, a3: u64, a4: u64, should_decode: bool) {
    let source = "
    use.std::math::ecgfp5::group
...
fn test_ecgfp5_point_encode(a0: u64, a1: u64, a2: u64, a3: u64, a4: u64) {
    let source = "
    use.std::math::ecgfp5::group
...
#[test]
fn test_ecgfp5_point_multiplication() {
    let source = "
    use.std::math::ecgfp5::group
...
#[test]
fn test_ecgfp5_gen_multiplication() {
    let source = "
    use.std::math::ecgfp5::group
