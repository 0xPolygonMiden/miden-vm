...
fn u32add3() {
    ...
    // should push e = floor((a + b + c) / 2^32) onto the stack.
    test_add3(asm_op);
}
...
proptest! {
    ...
    #[test]
    fn u32add3_proptest(a in any::<u32>(), b in any::<u32>(), c in any::<u32>()) {
        let asm_op = "u32add3";
